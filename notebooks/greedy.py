...
class GreedyFeatureSelection:
    ...
    def evaluate_score(self, X, y):
        ...
        :param y: targets
        :return: overfitted area under the curve
        """
        # fit the logistic regression model, 
        # and calculate the AUC on the same data
        # again: BEWARE
        # you can choose the model that suits your data
    ...
    def _feature_selection(self, X, y):
        ...
        while True:
            ...
            for feature in range(num_features):
                # if feature is already good feature,
                # skip this for loop
                ...
                # of this loop, change the best score and best feature
                if score > best_score:
        ...
        # return the best scores and good features
...
if __name__=="__main__":
    # generate binaryclassification data
    X, y = make_classification(n_samples=1000, n_features=100)

    # transform the data by greedy feature selection
